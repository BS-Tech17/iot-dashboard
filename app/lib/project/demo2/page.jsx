...
const actuators = [
  { type: "Pressure Sensor", use: "Monitors pressure", examples: "Industrial monitoring" },
];

function generatePlausibleSensorData(sensorName, count = 20) {
  const sensorMetadata = {
    "Pressure": { unit: "Pa", min: 90000, max: 110000 },
  };
...
export default function Demo2ProjectPage() {
  const [activeActuators, setActiveActuators] = useState([]);
  const sensorStats = [
    generatePlausibleSensorData("Pressure"),
  ];
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-white via-blue-100 to-blue-300">
      ...
      <main className="flex-1 py-12 px-8 flex">
        <div className="flex-1 pr-8">
          <h1 className="text-xl text-blue-900 font-semibold mb-6">Industrial Monitoring</h1>
